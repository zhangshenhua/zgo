...
CREATE OR REPLACE VIEW VIEW_ZI AS
    SELECT * FROM ZI
;

DROP TRIGGER IF EXISTS after_zi_insert_trigger ON VIEW_ZI;
...
-- select setval('zi_id_seq', 0);
-- SELECT currval('zi_id_seq');
-- insert INTO VIEW_ZI (x, y, uid) SELECT  9,  8,   1;
-- insert INTO VIEW_ZI (x, y, uid) SELECT  8,  9,   1;
-- insert INTO VIEW_ZI (x, y, uid) SELECT  9,  10,  1;
-- insert INTO VIEW_ZI (x, y, uid) SELECT  10,  8,  2;
-- insert INTO VIEW_ZI (x, y, uid) SELECT  11,  9,  2;
-- insert INTO VIEW_ZI (x, y, uid) SELECT  10,  10, 2;
-- insert INTO VIEW_ZI (x, y, uid) SELECT  9,   9,  2;
-- insert INTO VIEW_ZI (x, y, uid) SELECT  10,  9,  1;
-- SELECT * from ZI;
